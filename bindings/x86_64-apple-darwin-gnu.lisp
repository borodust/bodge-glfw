...
(defparameter %glfw::+expose-native-cocoa+ 1)
...
(declaim (inline %glfw::get-cocoa-monitor))

(cffi:defcfun ("glfwGetCocoaMonitor" %glfw::get-cocoa-monitor) :int)

(cffi:defctype %glfw.ext::id (claw-utils:claw-pointer :void))

(declaim (inline %glfw::get-cocoa-window))

(cffi:defcfun ("glfwGetCocoaWindow" %glfw::get-cocoa-window)
              %glfw.ext::id
              (%glfw::window (claw-utils:claw-pointer %glfw::window)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%glfw::get-cocoa-monitor :%glfw)
