;; Generated by :claw at 2023-09-13T17:53:14.447255Z
...
(cffi:defcenum (%glfw.ext::vk-internal-allocation-type :unsigned-int)
  "/usr/include/vulkan/vulkan_core.h:1092:14"
  (:executable 0)
  (:max-enum 2147483647))
...
(cffi:defcenum (%glfw.ext::vk-result :int)
  ...
  (:error-invalid-opaque-capture-address-khr -1000257000)
  (:error-pipeline-compile-required-ext 1000297000)
  (:result-max-enum 2147483647))

(cffi:defcenum (%glfw.ext::vk-system-allocation-scope :unsigned-int)
  "/usr/include/vulkan/vulkan_core.h:1083:14"
  (:command 0)
  (:object 1)
  (:cache 2)
  (:device 3)
...
(defparameter %glfw::+x-string-style+ 0)

(defparameter %glfw::+x-compound-text-style+ 1)

(defparameter %glfw::+x-text-style+ 2)

(defparameter %glfw::+x-std-icc-text-style+ 3)

(defparameter %glfw::+xutf8string-style+ 4)

(defparameter %glfw::+xim-forward-char+ 0)

(defparameter %glfw::+xim-backward-char+ 1)

(defparameter %glfw::+xim-forward-word+ 2)

(defparameter %glfw::+xim-backward-word+ 3)

(defparameter %glfw::+xim-caret-up+ 4)

(defparameter %glfw::+xim-caret-down+ 5)

(defparameter %glfw::+xim-next-line+ 6)

(defparameter %glfw::+xim-previous-line+ 7)

(defparameter %glfw::+xim-line-start+ 8)

(defparameter %glfw::+xim-line-end+ 9)

(defparameter %glfw::+xim-absolute-position+ 10)

(defparameter %glfw::+xim-dont-change+ 11)

(defparameter %glfw::+xim-is-invisible+ 0)

(defparameter %glfw::+xim-is-primary+ 1)

(defparameter %glfw::+xim-is-secondary+ 2)

(defparameter %glfw::+xim-text-type+ 0)

(defparameter %glfw::+xim-bitmap-type+ 1)

(defparameter %glfw::+xom-orientation-ltr-ttb+ 0)

(defparameter %glfw::+xom-orientation-rtl-ttb+ 1)

(defparameter %glfw::+xom-orientation-ttb-ltr+ 2)

(defparameter %glfw::+xom-orientation-ttb-rtl+ 3)

(defparameter %glfw::+xom-orientation-context+ 4)

(defparameter %glfw::+khronos-false+ 0)

(defparameter %glfw::+khronos-true+ 1)

(defparameter %glfw::+khronos-boolean-enum-force-size+ 2147483647)
...
(cffi:defcstruct (%glfw::image :size 16)
  ...
  (%glfw::pixels (claw-utils:claw-pointer :unsigned-char) :offset 8))
...
(cffi:defcfun ("glfwCreateStandardCursor" %glfw::create-standard-cursor)
    (claw-utils:claw-pointer %glfw::cursor)
  (%glfw::shape :int))
...
(cffi:defcfun ("glfwCreateWindow" %glfw::create-window)
  ...
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor))
...
(cffi:defctype %glfw.ext::vk-instance
               (claw-utils:claw-pointer (:struct %glfw.ext::vk-instance-t)))
...
(cffi:defctype %glfw.ext::pfn-vk-free-function (claw-utils:claw-pointer :void))
...
(cffi:defcstruct (%glfw.ext::vk-allocation-callbacks :size 48)
  (%glfw::p-user-data (claw-utils:claw-pointer :void) :offset 0)
  (%glfw::pfn-allocation %glfw.ext::pfn-vk-allocation-function :offset 8)
  (%glfw::pfn-reallocation %glfw.ext::pfn-vk-reallocation-function :offset 16)
  (%glfw::pfn-free %glfw.ext::pfn-vk-free-function :offset 24)
  (%glfw::pfn-internal-allocation
   %glfw.ext::pfn-vk-internal-allocation-notification :offset 32)
  (%glfw::pfn-internal-free %glfw.ext::pfn-vk-internal-free-notification
   :offset 40))
...
(cffi:defctype %glfw.ext::vk-surface-khr
               (claw-utils:claw-pointer (:struct %glfw.ext::vk-surface-khr-t)))

(declaim (inline %glfw::create-window-surface))

(cffi:defcfun ("glfwCreateWindowSurface" %glfw::create-window-surface)
    %glfw.ext::vk-result
  (%glfw::instance %glfw.ext::vk-instance)
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::allocator
   (claw-utils:claw-pointer %glfw.ext::vk-allocation-callbacks))
  (%glfw::surface (claw-utils:claw-pointer %glfw.ext::vk-surface-khr)))
...
(cffi:defcfun ("glfwGetError" %glfw::get-error)
    :int
  (%glfw::description claw-utils:claw-string))
...
(cffi:defcfun ("glfwGetGamepadState" %glfw::get-gamepad-state)
    :int
  (%glfw::jid :int)
  (%glfw::state (claw-utils:claw-pointer %glfw::gamepadstate)))

(cffi:defcstruct (%glfw::gammaramp :size 32)
  (%glfw::red (claw-utils:claw-pointer :unsigned-short) :offset 0)
  (%glfw::green (claw-utils:claw-pointer :unsigned-short) :offset 8)
  (%glfw::blue (claw-utils:claw-pointer :unsigned-short) :offset 16)
...
(cffi:defcfun ("glfwGetInstanceProcAddress" %glfw::get-instance-proc-address)
    %glfw::vkproc
  (%glfw::instance %glfw.ext::vk-instance)
...
(cffi:defcfun ("glfwGetJoystickUserPointer" %glfw::get-joystick-user-pointer)
    (claw-utils:claw-pointer :void)
  (%glfw::jid :int))
...
(cffi:defcfun ("glfwGetMonitorContentScale" %glfw::get-monitor-content-scale)
    :void
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor))
...
(cffi:defcfun ("glfwGetMonitorPhysicalSize" %glfw::get-monitor-physical-size)
    :void
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor))
...
(cffi:defcfun ("glfwGetMonitorUserPointer" %glfw::get-monitor-user-pointer)
    (claw-utils:claw-pointer :void)
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor)))
...
(cffi:defcfun ("glfwGetMonitors" %glfw::get-monitors)
    (claw-utils:claw-pointer (claw-utils:claw-pointer %glfw::monitor))
  (%glfw::count (claw-utils:claw-pointer :int)))
...
(cffi:defcfun ("glfwGetRequiredInstanceExtensions"
    ...
    claw-utils:claw-string
  (%glfw::count (claw-utils:claw-pointer %glfw.ext::uint32-t)))

(declaim (inline %glfw::get-time))

(cffi:defcfun ("glfwGetTime" %glfw::get-time)
    :double)
...
(cffi:defcfun ("glfwGetWindowContentScale" %glfw::get-window-content-scale)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::xscale (claw-utils:claw-pointer :float))
  (%glfw::yscale (claw-utils:claw-pointer :float)))
...
(cffi:defcfun ("glfwGetWindowUserPointer" %glfw::get-window-user-pointer)
    (claw-utils:claw-pointer :void)
  (%glfw::window (claw-utils:claw-pointer %glfw::window)))
...
(cffi:defcfun ("glfwGetX11SelectionString" %glfw::get-x11selection-string)
    claw-utils:claw-string)
...
(cffi:defcfun ("glfwInit" %glfw::init)
    :int)
...
(cffi:defcfun ("glfwPollEvents" %glfw::poll-events)
    :void)

(declaim (inline %glfw::post-empty-event))

(cffi:defcfun ("glfwPostEmptyEvent" %glfw::post-empty-event)
    :void)

(declaim (inline %glfw::raw-mouse-motion-supported))

(cffi:defcfun ("glfwRawMouseMotionSupported" %glfw::raw-mouse-motion-supported)
    :int)

(declaim (inline %glfw::request-window-attention))

(cffi:defcfun ("glfwRequestWindowAttention" %glfw::request-window-attention)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window)))
...
(cffi:defcfun ("glfwSetCharModsCallback" %glfw::set-char-mods-callback)
    %glfw::charmodsfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defcfun ("glfwSetCursorEnterCallback" %glfw::set-cursor-enter-callback)
    %glfw::cursorenterfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defcfun ("glfwSetCursorPosCallback" %glfw::set-cursor-pos-callback)
    %glfw::cursorposfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defctype %glfw::framebuffersizefun (claw-utils:claw-pointer :void))
...
(cffi:defcfun ("glfwSetGammaRamp" %glfw::set-gamma-ramp)
    :void
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor))
  (%glfw::ramp (claw-utils:claw-pointer %glfw::gammaramp)))
...
(cffi:defcfun ("glfwSetJoystickCallback" %glfw::set-joystick-callback)
    %glfw::joystickfun
  (%glfw::callback %glfw::joystickfun))

(declaim (inline %glfw::set-joystick-user-pointer))

(cffi:defcfun ("glfwSetJoystickUserPointer" %glfw::set-joystick-user-pointer)
    :void
  (%glfw::jid :int)
...
(cffi:defcfun ("glfwSetMonitorUserPointer" %glfw::set-monitor-user-pointer)
    :void
  (%glfw::monitor (claw-utils:claw-pointer %glfw::monitor))
  (%glfw::pointer (claw-utils:claw-pointer :void)))
...
(cffi:defcfun ("glfwSetMouseButtonCallback" %glfw::set-mouse-button-callback)
    %glfw::mousebuttonfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defcfun ("glfwSetWindowAspectRatio" %glfw::set-window-aspect-ratio)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::numer :int)
  (%glfw::denom :int))
...
(cffi:defcfun ("glfwSetWindowCloseCallback" %glfw::set-window-close-callback)
    %glfw::windowclosefun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::callback %glfw::windowclosefun))

(cffi:defctype %glfw::windowcontentscalefun (claw-utils:claw-pointer :void))
...
(cffi:defcfun ("glfwSetWindowFocusCallback" %glfw::set-window-focus-callback)
    %glfw::windowfocusfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defctype %glfw::windowiconifyfun (claw-utils:claw-pointer :void))
...
(cffi:defctype %glfw::windowmaximizefun (claw-utils:claw-pointer :void))
...
(cffi:defcfun ("glfwSetWindowPosCallback" %glfw::set-window-pos-callback)
    %glfw::windowposfun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::callback %glfw::windowposfun))

(cffi:defctype %glfw::windowrefreshfun (claw-utils:claw-pointer :void))
...
(cffi:defcfun ("glfwSetWindowShouldClose" %glfw::set-window-should-close)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::value :int))
...
(cffi:defcfun ("glfwSetWindowSizeCallback" %glfw::set-window-size-callback)
    %glfw::windowsizefun
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
...
(cffi:defcfun ("glfwSetWindowSizeLimits" %glfw::set-window-size-limits)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::minwidth :int)
  (%glfw::minheight :int)
...
(cffi:defcfun ("glfwSetWindowUserPointer" %glfw::set-window-user-pointer)
    :void
  (%glfw::window (claw-utils:claw-pointer %glfw::window))
  (%glfw::pointer (claw-utils:claw-pointer :void)))
...
(cffi:defcfun ("glfwSetX11SelectionString" %glfw::set-x11selection-string)
    :void
  (%glfw::string claw-utils:claw-string))
...
(cffi:defcfun ("glfwTerminate" %glfw::terminate)
    :void)

(declaim (inline %glfw::update-gamepad-mappings))

(cffi:defcfun ("glfwUpdateGamepadMappings" %glfw::update-gamepad-mappings)
    :int
  (%glfw::string claw-utils:claw-string))

(declaim (inline %glfw::vulkan-supported))

(cffi:defcfun ("glfwVulkanSupported" %glfw::vulkan-supported)
    :int)

(declaim (inline %glfw::wait-events))

(cffi:defcfun ("glfwWaitEvents" %glfw::wait-events)
    :void)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%glfw.ext::vk-internal-allocation-type :%glfw.ext)
  (export '%glfw.ext::vk-result :%glfw.ext)
  (export '%glfw.ext::vk-system-allocation-scope :%glfw.ext)
  (export '%glfw::+x-string-style+ :%glfw)
  (export '%glfw::+x-compound-text-style+ :%glfw)
  (export '%glfw::+x-text-style+ :%glfw)
  (export '%glfw::+x-std-icc-text-style+ :%glfw)
  (export '%glfw::+xutf8string-style+ :%glfw)
  (export '%glfw::+xim-forward-char+ :%glfw)
  (export '%glfw::+xim-backward-char+ :%glfw)
  (export '%glfw::+xim-forward-word+ :%glfw)
  (export '%glfw::+xim-backward-word+ :%glfw)
  (export '%glfw::+xim-caret-up+ :%glfw)
  (export '%glfw::+xim-caret-down+ :%glfw)
  (export '%glfw::+xim-next-line+ :%glfw)
  (export '%glfw::+xim-previous-line+ :%glfw)
  (export '%glfw::+xim-line-start+ :%glfw)
  (export '%glfw::+xim-line-end+ :%glfw)
  (export '%glfw::+xim-absolute-position+ :%glfw)
  (export '%glfw::+xim-dont-change+ :%glfw)
  (export '%glfw::+xim-is-invisible+ :%glfw)
  (export '%glfw::+xim-is-primary+ :%glfw)
  (export '%glfw::+xim-is-secondary+ :%glfw)
  (export '%glfw::+xim-text-type+ :%glfw)
  (export '%glfw::+xim-bitmap-type+ :%glfw)
  (export '%glfw::+xom-orientation-ltr-ttb+ :%glfw)
  (export '%glfw::+xom-orientation-rtl-ttb+ :%glfw)
  (export '%glfw::+xom-orientation-ttb-ltr+ :%glfw)
  (export '%glfw::+xom-orientation-ttb-rtl+ :%glfw)
  (export '%glfw::+xom-orientation-context+ :%glfw)
  (export '%glfw::+khronos-false+ :%glfw)
  (export '%glfw::+khronos-true+ :%glfw)
  (export '%glfw::+khronos-boolean-enum-force-size+ :%glfw)
  (export '%glfw::cursor :%glfw)
  ...
  (export '%glfw.ext::pfn-vk-internal-allocation-notification :%glfw.ext)
