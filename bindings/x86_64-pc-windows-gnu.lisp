...
(defparameter %glfw::+expose-native-win32+ 1)
...
(declaim (inline %glfw::get-win32adapter))

(cffi:defcfun ("glfwGetWin32Adapter" %glfw::get-win32adapter)
              claw-utils:claw-string
              (%glfw::monitor (:pointer %glfw::monitor)))

(declaim (inline %glfw::get-win32monitor))

(cffi:defcfun ("glfwGetWin32Monitor" %glfw::get-win32monitor)
              claw-utils:claw-string
              (%glfw::monitor (:pointer %glfw::monitor)))

(declaim (inline %glfw::get-win32window))

(cffi:defcfun ("glfwGetWin32Window" %glfw::get-win32window) :int)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%glfw::+expose-native-win32+ :%glfw)
  ...
  (export '%glfw::get-win32monitor :%glfw)
  ...
  (export '%glfw::get-win32adapter :%glfw)
  ...
  (export '%glfw::get-win32window :%glfw)
